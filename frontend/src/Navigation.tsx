...
import TrendhubsLogo from './assets/cute_docsgpt3.svg';
      ...
      >
        ...
        >
          ...
          >
            <a href="/" className="flex gap-1.5">
              <img className="mb-2 h-10" src={TrendhubsLogo} alt="Trendhubs logo" />
              <p className="my-auto text-2xl font-semibold">Trendhubs</p>
            </a>
          </div>
          <button
        ...
        <div className="flex h-auto flex-col justify-end text-eerie-black dark:text-white">
          <div className="flex flex-col-reverse border-b-[1px] dark:border-b-purple-taupe">
            <p className="ml-5 mb-3 text-lg font-bold text-eerie-black dark:text-bright-gray">
              Upload your documents
            </p>
            <div className="relative mb-4 mx-4 flex gap-2">
              <SourceDropdown
                options={docs}
